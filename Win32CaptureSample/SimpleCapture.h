...
public:
    ...
    {
        CheckClosed();
        return m_visualizeDirtyRegions.load();
    }
    ...
    {
        CheckClosed();
        return m_session.MinUpdateInterval();
    }
    void MinUpdateInterval(winrt::Windows::Foundation::TimeSpan value)
    {
        CheckClosed();
        m_session.MinUpdateInterval(value);
    }
